...
class Path(object):
    ...
    def arcs_reversed(self):
        """enumerates the arcs for the path.
        This starts at the end and enumerates arcs in the path backwards."""
        current = self
    ...
    def arcs(self):
        """enumerates the arcs for the path.
        This starts at the beginning and enumerates arcs in the path forwards."""
        arcs_rev = [arc for arc in self.arcs_reversed()]
        arcs_rev.reverse()
        for current in arcs_rev:
            yield current
